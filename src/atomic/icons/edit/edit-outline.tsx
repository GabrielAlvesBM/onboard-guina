const EditOutline = ({ size = 24 }: { size?: number }) => {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M14.9099 4.15039C15.2415 5.32786 15.8699 6.40046 16.7349 7.26544C17.5998 8.13042 18.6724 8.7588 19.8499 9.09039"
        stroke-width="1.5"
        stroke-miterlimit="10"
        stroke-linecap="round"
        stroke-linejoin="round"
